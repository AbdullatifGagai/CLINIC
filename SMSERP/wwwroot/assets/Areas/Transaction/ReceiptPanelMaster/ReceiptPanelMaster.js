        ...
        if (data && data.length > 0) {
            ...
            for (const item of data) {
               ...
               <tr>
                              ...
                              <td><input type="text" class="form-control CloseingAmt"   value="${item.Amt}" /></td>
...
function AddRow() {
    ...
    var StudentId = parseInt($('#StudentN').val());
  ...
  //  $('#LevelId').val(Id)
    ...
    GetJSONRequest('/Master/Student/StudentlistPanelGrId', 'GET', { MonthId, PanelId, StudentId }, data => {
               ...
               /// var Total = item.AdmissionFee + item.MonthlyFee;
                ...
                const markup = `
                            <tr>
                              ...
                              <td><input type="text" class="form-control CloseingAmt"   value="${item.CloseingAmt}" /></td>
...
$('#PanelId').change(function () {
    let PanelId = parseInt($('#PanelId').val());
    ...
    GetJSONRequest('/Master/Student/Master_StudentGetPanelId', 'GET', { PanelId }, data => {
...
$('tbody.VoucherDetail').delegate('.CloseingAmt', 'change', function () {
