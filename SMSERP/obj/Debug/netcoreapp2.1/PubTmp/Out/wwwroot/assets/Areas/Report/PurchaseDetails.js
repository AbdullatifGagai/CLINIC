...
$('#SPrint').click(function (e) {
    ...
    var value = `/Report/Reportrdlc/AReport?rvalues.Name=35&rvalues.Value[0]=${$('#FromDate').val()}&rvalues.Value[1]=${$('#ToDate').val()}&rvalues.Value[2]=${$('#SupId').val()}&rvalues.Value[3]=''&rvalues.Value[4]=''&rvalues.Value[5]=''&rvalues.Value[6]=${Date}`
