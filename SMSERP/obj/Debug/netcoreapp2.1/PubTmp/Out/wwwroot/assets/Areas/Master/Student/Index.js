...
$(document).ready(() => {
    ...
    const table = $('.ServerSidePagination').DataTable({
        ...
        "ajax": {
            ...
            "url": "/Master/Student/Master_CCStudentGetAll",
            "type": "POST",
            "datatype": "json",
            ...
            //},
            {
                "render": (data, row, full) => {
                    ...
                    if (editview) {
                        ...
                        markup += `<li class="text-primary-600"><a data-modalhorizontal="true" data-modalsize="modal-lg" data-heading="Edit Admission" data-script="#" data-url="/Master/Student/A_Admission?Id=${full.GRId}"><i class="icon-pencil7"></i></a></li>`
                           /* < li class="text-primary-600" > <a data-modalhorizontal="true" data-modalsize="modal-lg" data-heading="Edit Customer" data-script="#" data-url="/Master/Customer/ACustomer?Id=@s.CustomerId"><i class="icon-pencil7"></i></a></li >*/

                    }


                    if (deleteview) {
                        markup += `<li class="text-danger-600"><a onclick="DeleteAlert({ 'Id':${full.GRId}}, '/Master/Student/DeleteStudent', 'Admission')"><i class="icon-trash"></i></a></li>`
                    }
                    ...
                    if (editview) {
                        markup += `<li class="text-primary-600"><a data-modalhorizontal="true" data-modalsize="modal-lg" data-heading="Receipt" data-script="/assets/Areas/Transaction/Receipt/AdReceipt.js" data-url="/Transaction/Receipt/AdmissionReceipt?Id=${full.GRId}"><i class="icon-copy2"></i></a></li>`
                    }
...
$('#body').delegate('.PrintBtn', 'click', function () {
    ...
    //GetJSONRequest('/Transaction/OrReceipt/Transaction_OrReceiptGetByIdPrint', 'GET', { id }, function (data) {
    ...
    var value = `/Report/Reportrdlc/AReport?rvalues.Name=36&rvalues.Value[0]=${id}&rvalues.Value[1]=''&rvalues.Value[2]=''&rvalues.Value[3]=''&rvalues.Value[4]=1&rvalues.Value[5]=''&rvalues.Value[6]=''`
