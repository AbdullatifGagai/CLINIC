...
namespace ZCLINIC.Areas.Master.Models
{
    public class Master_Community
    {
        ...
        public string Master_CommunitySave(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                ...
                string message = DataBase.ExecuteQuery<Master_Community>(parameters, Connection.GetConnection()).FirstOrDefault().ReturnMessage;
        ...
        public string Master_CommunityUpdate(BValues bv, string ip, string cInfo)
        {
            var parameters = new { x = this };
        ...
        public Master_Community Master_CommunityGetById(int id, BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                Master_Community record = DataBase.ExecuteQuery<Master_Community>(parameters, Connection.GetConnection()).FirstOrDefault();
        ...
        public List<Master_Community> Master_CommunityGetAll(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                List<Master_Community> records = DataBase.ExecuteQuery<Master_Community>(parameters, Connection.GetConnection());
        ...
        public DataTable CommunityGetAllTable(BValues bv, string ip, string cInfo)
        {
            var parameters = new { bv.UserId, bv.TenantId, bv.AppId };

            try
            {
                DataTable dataTable = DataBase.ExecuteforReport(parameters, Connection.GetConnection(), "Master_Master_CommunityGetAllTable");
