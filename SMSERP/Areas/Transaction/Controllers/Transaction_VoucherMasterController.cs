...
namespace ZCLINIC.Areas.Transaction.Controllers
{
    ...
    public class Transaction_VoucherMasterController : Controller
    {
        ...
        {
            return View(new Transaction_VoucherMasterApiController().Transaction_VoucherMasterGetAll("",HttpContext.Session.GetBValues(), HttpContext.GetIP(), HttpContext.GetCInfo()));
        }

        // create/edit view for Transaction_VoucherMaster
        public IActionResult ATransaction_VoucherMaster(int id = 0)
        {
        ...
        [HttpPost]
        public string SaveTransaction_VoucherMaster(Transaction_VoucherMaster model)
        {
        ...
        [HttpPost]
        public string UpdateTransaction_VoucherMaster(Transaction_VoucherMaster model)
        {
        ...
        [HttpPost]
        public string DeleteTransaction_VoucherMaster(int id)
        {
