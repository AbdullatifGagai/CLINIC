...
namespace ZCLINIC.Areas.URM.Models
{
    public class URM_RoleDetail
    {
        ...
        public string URM_URM_RoleDetailSave(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                ...
                string message = DataBase.ExecuteQuery<URM_RoleDetail>(parameters, Connection.GetConnection()).FirstOrDefault().ReturnMessage;
        ...
        public string URM_URM_RoleDetailUpdate(BValues bv, string ip, string cInfo)
        {
            var parameters = new { x = this };
        ...
        public URM_RoleDetail URM_URM_RoleDetailGetById(int id, BValues bv, string ip, string cInfo)
        {
            var parameters = new { bv.UserId, bv.TenantId, bv.AppId, Id = id };

            try
            {
                URM_RoleDetail record = DataBase.ExecuteQuery<URM_RoleDetail>(parameters, Connection.GetConnection()).FirstOrDefault();
        ...
        public List<URM_RoleDetail> URM_URM_RoleDetailGetAll(BValues bv, string ip, string cInfo)
        {
        ...
        public DataTable URM_URM_RoleDetailGetAllTable(BValues bv, string ip, string cInfo)
        {
            var parameters = new { bv.UserId, bv.TenantId, bv.AppId };

            try
            {
                DataTable dataTable = DataBase.ExecuteforReport(parameters, Connection.GetConnection(), "URM_URM_RoleDetailGetAllTable");
        ...
        public string URM_URM_RoleDetailDelete(int id, BValues bv, string ip, string cInfo)
        {
            var parameters = new { bv.UserId, bv.TenantId, bv.AppId, Id = id };
