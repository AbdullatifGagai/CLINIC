        ...
        "columns": [
            ...
            //},
            {
                "render": (data, row, full) => {
                    ...
                    if (deleteview) {
                        markup += `<li class="text-danger-600"><a onclick="DeleteAlert({ 'Id':${full.Receipt_no}}, '/Transaction/MisReceipt/DeleteMisReceipt', 'MisReceipt')"><i class="icon-trash"></i></a></li>`
                    }
                    ...
                    if (editview) {
                        markup += `<li class="text-primary-600"><a data-modalhorizontal="true" data-modalsize="modal-lg" data-heading="Edit Mis Receipt" data-script="#" data-url="/Transaction/MisReceipt/AMisReceipt?Id=${full.Receipt_no}"><i class="icon-pencil7"></i></a></li>`
                    }
...
$('#body').delegate('.PrintBtn', 'click', function () {
    ...
    var value = `/Report/Reportrdlc/AReport?rvalues.Name=29&rvalues.Value[0]=${id}&rvalues.Value[1]=''&rvalues.Value[2]=''&rvalues.Value[3]=''&rvalues.Value[4]=1&rvalues.Value[5]=''&rvalues.Value[6]=''`
