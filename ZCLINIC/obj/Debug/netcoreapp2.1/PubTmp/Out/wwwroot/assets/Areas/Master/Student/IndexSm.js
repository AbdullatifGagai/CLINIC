...
$(document).ready(() => {
    ...
    const table = $('.ServerSidePagination').DataTable({
        ...
        "ajax": {
            ...
            "url": "/Master/Student/Master_StudentGetAll",
            "type": "POST",
            "datatype": "json",
            ...
            //},
            {
                "render": (data, row, full) => {
                    ...
                    if (editview) {
                        ...
                        markup += `<li class="text-primary-600"><a data-modalhorizontal="true" data-modalsize="modal-lg" data-heading="Edit Student Admission" data-script="/assets/Areas/Master/Student/StudentSm.js" data-url="/Master/Student/AStudent?Id=${full.GRId}"><i class="icon-pencil7"></i></a></li>`
   
                    }


                    if (deleteview) {
                        markup += `<li class="text-danger-600"><a onclick="DeleteAlert({ 'Id':${full.GRId}}, '/Master/Student/DeleteStudent', 'Student Admission')"><i class="icon-trash"></i></a></li>`
