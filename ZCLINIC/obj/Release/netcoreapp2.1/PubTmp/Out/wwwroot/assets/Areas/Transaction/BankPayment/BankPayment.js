...
function AddRow() {
    ...
    if (parseFloat($('.Debitfield').val()) > 0 && parseFloat($('.Creditfield').val()) > 0) {
        ErrorAlert("Debit And Credit Are Equal")
    }

    else if (parseFloat($('.Debitfield').val()) == 0 && parseFloat($('.Creditfield').val()) == 0) {
        ErrorAlert("Debit And Credit Are Equal")
    }
...
$('.SaveBtn').click(() => {
    ...
    if (!check && DebitAmt == CreditAmt) {
        ...
        ErrorAlert('Debit And Credit Are Not Equal')
        }
    })
