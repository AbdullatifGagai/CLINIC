...
$(document).ready(() => {
    ...
    const table = $('.ServerSidePagination').DataTable({
        ...
        "ajax": {
            ...
            "url": "/Master/Student/Master_StudentGetAllSAI",
            "type": "POST",
            "datatype": "json",
            ...
            //},
            {
                "render": (data, row, full) => {
                    ...
                    if (editview) {
                        ...
                        markup += `<li class="text-primary-600"><a data-modalhorizontal="true" data-modalsize="modal-full" data-heading="Edit Admission Form" data-script="#" data-url="/Master/Student/AdmissionSAI?Id=${full.GRId}"><i class="icon-pencil7"></i></a></li>`
                          
                    }


                    if (deleteview) {
                        markup += `<li class="text-danger-600"><a onclick="DeleteAlert({ 'Id':${full.GRId}}, '/Master/Student/DeleteStudent', 'Admission Form (SAI)')"><i class="icon-trash"></i></a></li>`
