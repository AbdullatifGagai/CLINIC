...
function PurchaseOrderDetail(id) {
    ...
    GetJSONRequest('/Transaction/PurchaseDetail/PurchaseDetailGetById', 'GET', { id }, data => {
...
$('.SaveBtn').on('click', function () {
    ...
    if (SupId == 0 || SupId == null) {
        ErrorAlert("Enter Supplier  Name");
        check = true;
    }
    ...
    if (!check) {
        ...
        Purchase = {
            ...
            SupId: parseInt($('#SupId option:selected').val()),
        ...
        if (PurId > 0) {
            ...
            debugger;
            GetJSONRequest('/Transaction/Purchase/UpdatePurchase', 'POST', { Purchase, PurchaseDetail}, function (data) {
            ...
            GetJSONRequest('/Transaction/Purchase/SavePurchase', 'POST', { Purchase, PurchaseDetail}, function (data) {
                SuccessAlert("Data Saved");
                $('.closeBtn').trigger('click');
