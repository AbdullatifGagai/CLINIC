    ...
    if (!check) {
        ...
        $('#tbodytable tr').each(function () {
            ...
            LabtestDetail.push({
                ...
                TestId: $('#TestId').val(),
                Discri: parseInt($(this).find(".Dis").val()),
                Unit: parseFloat($(this).find(".Unit").val()),
        ...
        if (TestId > 0) {
            ...
            debugger;
            GetJSONRequest('/Transaction/Labtest/UpdateLabtest', 'POST', { Labtest, LabtestDetail }, function (data) {
            ...
            GetJSONRequest('/Transaction/Labtest/SaveLabtest', 'POST', { Labtest, LabtestDetail }, function (data) {
                SuccessAlert("Data Saved");
                $('.closeBtn').trigger('click');
