...
$('#StockQtyPrint').click(function (e) {
  ...
  /*  if ($('#ReportId').val() == 1) {*/
    ...
    var value = `/Report/Reportrdlc/AReport?rvalues.Name=33&rvalues.Value[0]=${$('#storeId').val()}&rvalues.Value[1]=${$('#FromDate').val()}&rvalues.Value[2]=${$('#ToDate').val()}&rvalues.Value[3]=${$('#ProductId').val()}&rvalues.Value[4]=''&rvalues.Value[5]=''&rvalues.Value[6]=${Date}`
...
$('#SPrint').click(function (e) {
    ...
    var value = `/Report/Reportrdlc/AReport?rvalues.Name=16&rvalues.Value[0]=${$('#FromDate').val()}&rvalues.Value[1]=${$('#ToDate').val()}&rvalues.Value[2]=${$('#storeId').val()}&rvalues.Value[3]=''&rvalues.Value[4]=''&rvalues.Value[5]=''&rvalues.Value[6]=${Date}`
    $(this).attr('href', value)
    $(this).attr('target', "_blank")
