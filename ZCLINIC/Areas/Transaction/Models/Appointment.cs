...
namespace ZCLINIC.Areas.Transaction.Models
{
    public class Appointment
    {
        ...
        public string Transaction_AppointmentSave(BValues bv, string ip, string cInfo)
        {
        ...
        public string Transaction_AppointmentUpdate(BValues bv, string ip, string cInfo)
        {
            var parameters = new { x = this };
        ...
        public Appointment Transaction_AppointmentGetById(int id, BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                Appointment record = DataBase.ExecuteQuery<Appointment>(parameters, Connection.GetConnection()).FirstOrDefault();
        ...
        public List<Appointment> Transaction_AppointmentGetAll(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                List<Appointment> records = DataBase.ExecuteQuery<Appointment>(parameters, Connection.GetConnection());
        ...
        public DataTable Transaction_AppointmentGetAllTable(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                DataTable dataTable = DataBase.ExecuteforReport(parameters, Connection.GetConnection(), "Transaction_AppointmentGetAllTable");
        ...
        public string Transaction_AppointmentDelete(int id, BValues bv, string ip, string cInfo)
        {
            var parameters = new { bv.UserId, bv.TenantId, bv.AppId, Id = id };
