...
namespace ZCLINIC.Areas.Master.Models
{
    public class Master_Deparment
    {
        ...
        [TVP]
        public string DeparmnetN { get; set; }
        ...
        public string Master_DeparmentSave(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                ...
                string message = DataBase.ExecuteQuery<Master_Deparment>(parameters, Connection.GetConnection()).FirstOrDefault().ReturnMessage;
        ...
        public string Master_DeparmentUpdate(BValues bv, string ip, string cInfo)
        {
            var parameters = new { x = this };
        ...
        public Master_Deparment Master_DeparmentGetById(int id, BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                Master_Deparment record = DataBase.ExecuteQuery<Master_Deparment>(parameters, Connection.GetConnection()).FirstOrDefault();
        ...
        public List<Master_Deparment> Master_DeparmentGetAll(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                List<Master_Deparment> records = DataBase.ExecuteQuery<Master_Deparment>(parameters, Connection.GetConnection());
        ...
        public DataTable Master_DeparmentGetAllTable(BValues bv, string ip, string cInfo)
        {
            var parameters = new { bv.UserId, bv.TenantId, bv.AppId };

            try
            {
                DataTable dataTable = DataBase.ExecuteforReport(parameters, Connection.GetConnection(), "Master_Master_DeparmentGetAllTable");
