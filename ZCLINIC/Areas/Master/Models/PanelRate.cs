...
namespace ZCLINIC.Areas.Master.Models
{
    public class PanelRate
    {
        ...
        public string Master_PanelRateSave(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                ...
                string message = DataBase.ExecuteQuery<PanelRate>(parameters, Connection.GetConnection()).FirstOrDefault().ReturnMessage;
        ...
        public string Master_PanelRateUpdate(BValues bv, string ip, string cInfo)
        {
            var parameters = new { x = this };
        ...
        public PanelRate Master_PanelRateGetById(int id, BValues bv, string ip, string cInfo)
        {
            var parameters = new { bv.UserId, bv.TenantId, bv.AppId, Id = id };

            try
            {
                PanelRate record = DataBase.ExecuteQuery<PanelRate>(parameters, Connection.GetConnection()).FirstOrDefault();
        ...
        public List<PanelRate> Master_PanelRateGetAll(BValues bv, string ip, string cInfo)
        {
        ...
        public DataTable Master_PanelRateGetAllTable(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                DataTable dataTable = DataBase.ExecuteforReport(parameters, Connection.GetConnection(), "Master_PanelRateGetAllTable");
