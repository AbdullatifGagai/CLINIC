...
namespace ZCLINIC.Areas.Master.Models
{
    public class PatientReg
    {
        ...
        public string Master_PatientRegSave(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                ...
                string message = DataBase.ExecuteQuery<PatientReg>(parameters, Connection.GetConnection()).FirstOrDefault().ReturnMessage;
        ...
        public string Master_PatientRegUpdate(BValues bv, string ip, string cInfo)
        {
            var parameters = new { x = this };
        ...
        public PatientReg Master_PatientRegGetById(int id, BValues bv, string ip, string cInfo)
        {
            var parameters = new { bv.UserId, bv.TenantId, bv.AppId, Id = id };

            try
            {
                PatientReg record = DataBase.ExecuteQuery<PatientReg>(parameters, Connection.GetConnection()).FirstOrDefault();
        ...
        public List<PatientReg> Master_PatientRegGetAll(BValues bv, string ip, string cInfo)
        {
        ...
        public DataTable Master_PatientRegGetAllTable(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                DataTable dataTable = DataBase.ExecuteforReport(parameters, Connection.GetConnection(), "Master_PatientRegGetAllTable");
        ...
        public string Master_PatientRegDelete(int id, BValues bv, string ip, string cInfo)
        {
            var parameters = new { bv.UserId, bv.TenantId, bv.AppId, Id = id };
