...
{
    public class Master_SubAccount
    {
        ...
        [TVP]
        public string  Sub_accountCode { get; set; }
        [TVP]
        ...
        public string Master_SubAccountSave(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                ...
                string message = DataBase.ExecuteQuery<Master_SubAccount>(parameters, Connection.GetConnection()).FirstOrDefault().ReturnMessage;
        ...
        public string Master_SubAccountUpdate(BValues bv, string ip, string cInfo)
        {
            var parameters = new { x = this };
        ...
        public Master_SubAccount Master_SubAccountGetById(int id, BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                Master_SubAccount record = DataBase.ExecuteQuery<Master_SubAccount>(parameters, Connection.GetConnection()).FirstOrDefault();
        ...
        public List<Master_SubAccount> Master_SubAccountGetAll(BValues bv, string ip, string cInfo)
        {
            ...
            try
            {
                List<Master_SubAccount> records = DataBase.ExecuteQuery<Master_SubAccount>(parameters, Connection.GetConnection());
         ...
         public List<Master_SubAccount> Master_SubAccountGetBankMaster(BValues bv, string ip, string cInfo)
        {
            var parameters = new { bv.UserId, bv.TenantId, bv.AppId };
           ...
           public List<Master_SubAccount> Master_SubAccountGetIncomeMaster(BValues bv, string ip, string cInfo)
        {
            var parameters = new { bv.UserId, bv.TenantId, bv.AppId };
        ...
        public DataTable Master_Master_SubAccountGetAllTable(BValues bv, string ip, string cInfo)
        {
            var parameters = new { bv.UserId, bv.TenantId, bv.AppId };

            try
            {
                DataTable dataTable = DataBase.ExecuteforReport(parameters, Connection.GetConnection(), "Master_Master_SubAccountGetAllTable");
